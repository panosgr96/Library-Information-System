...
public class Category extends PopUpJpanel {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(GridCategory);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CategoryUPD upd = new CategoryUPD();
    ...
    private void jButChengActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButChengActionPerformed
        int row = this.GridCategory.getSelectedRow();
        if (row <0 ) {return;}
    ...
    private void DeleteButtomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtomActionPerformed
       ...
       try{
            ...
            this.GridCategory.setModel(ConnectDb.DbDefaultTableModel(ColumnNames, sql, parameter));
